...
#Sound effect for the eating action
pygame.mixer.init()
eatsound = pygame.mixer.Sound('eat.wav')

#Background music, (-1) means it's a loop
...
class Snake(object):
    ...
    # 뱀이 먹이를 먹을 때 호출, when the snake eats a sound effect should play
    def eat(self):
        eatsound.play
...
#I wanted to add obstacles, but after defining them I failed to make them appear
